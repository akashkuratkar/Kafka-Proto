...
public class BasicBuilder extends MessageBuilder {
	...
	public String encode(MessageType type, String msgId, String source, String body, String dest, Date received,TopicMessage topicMessage) {
		String payload = null;
		if (body != null)
			payload = body.trim();
		...
		sb.append(topicMessage.toString());
		if (payload == null) {
			sb.append(0);
			sb.append(sBodyMarker);
		} else {
